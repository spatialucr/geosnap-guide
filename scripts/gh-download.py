...
token = "f4e3ea8c579f75b1740f965b2bd3632d64ac3a7e"
...
def usage():
    ...
    """
    print(
        "usage: gh-download --token=token --org=org --repo=repo --branch=branch --folder=folder"
    )
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(
            argv, "t:o:r:b:f:", ["token=", "org=", "repo=", "branch=", "folder="]
        )
    ...
    github = Github("f4e3ea8c579f75b1740f965b2bd3632d64ac3a7e")
